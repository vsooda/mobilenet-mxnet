...
void GetImageFile(const std::string image_file,
    ...
    mean_b = 103.94,mean_g = 116.78,mean_r = 123.68;
...
int main(int argc, char* argv[]) {
    ...
    std::string json_file = "mobilenet-symbol.json";
    std::string param_file = "mobilenet-0000.params";
